...
namespace MonoSoftware.MonoX.DAL.RelationClasses
{
	...
	public partial class AuditInfoRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between AuditInfoEntity and AspnetUsersEntity over the m:1 relation they have, using the relation between the fields:
		/// AuditInfo.UserId - AspnetUsers.UserId
		/// </summary>
	...
	{
		internal static readonly IEntityRelation AspnetUsersEntityUsingUserIdStatic = new AuditInfoRelations().AspnetUsersEntityUsingUserId;
