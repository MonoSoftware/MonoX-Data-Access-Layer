...
namespace MonoSoftware.MonoX.DAL.FactoryClasses
{
	...
	{
		private static readonly Dictionary<MonoSoftware.MonoX.DAL.EntityType, string> _entityTypeNamesCache = new Dictionary<MonoSoftware.MonoX.DAL.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(MonoSoftware.MonoX.DAL.EntityType value in Enum.GetValues(typeof(MonoSoftware.MonoX.DAL.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(MonoSoftware.MonoX.DAL.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(MonoSoftware.MonoX.DAL.EntityType relatedEntityType)
		{
