...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'CalendarViewRole'.<br/><br/></summary>
	[Serializable]
	public partial class CalendarViewRoleEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static CalendarViewRoleEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public CalendarViewRoleEntity():base("CalendarViewRoleEntity")
		{
		...
		public CalendarViewRoleEntity(IEntityFields2 fields):base("CalendarViewRoleEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this CalendarViewRoleEntity</param>
		public CalendarViewRoleEntity(IValidator validator):base("CalendarViewRoleEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="calendarId">PK value for CalendarViewRole which data should be fetched into this CalendarViewRole object</param>
		/// <param name="roleId">PK value for CalendarViewRole which data should be fetched into this CalendarViewRole object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CalendarViewRoleEntity(System.Guid calendarId, System.Guid roleId):base("CalendarViewRoleEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this CalendarViewRoleEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CalendarViewRoleEntity(System.Guid calendarId, System.Guid roleId, IValidator validator):base("CalendarViewRoleEntity")
		{
			InitClassEmpty(validator, null);
			this.CalendarId = calendarId;
			this.RoleId = roleId;
		...
		{
			switch((CalendarViewRoleFieldIndex)fieldIndex)
			{
				case CalendarViewRoleFieldIndex.CalendarId:
					DesetupSyncCalendar(true, false);
					break;
				case CalendarViewRoleFieldIndex.RoleId:
		...
		{
			return new CalendarViewRoleRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(CalendarViewRoleEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _calendar, new PropertyChangedEventHandler( OnCalendarPropertyChanged ), "Calendar", MonoSoftware.MonoX.DAL.RelationClasses.StaticCalendarViewRoleRelations.CalendarEntityUsingCalendarIdStatic, true, signalRelatedEntity, "CalendarViewRoles", resetFKFields, new int[] { (int)CalendarViewRoleFieldIndex.CalendarId } );
			_calendar = null;
		}
		...
		private void SetupSyncCalendar(IEntity2 relatedEntity)
		{
			if(_calendar!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _calendar, new PropertyChangedEventHandler( OnCalendarPropertyChanged ), "Calendar", MonoSoftware.MonoX.DAL.RelationClasses.StaticCalendarViewRoleRelations.CalendarEntityUsingCalendarIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this CalendarViewRoleEntity</param>
		...
		public  static CalendarViewRoleRelations Relations
		{
			get	{ return new CalendarViewRoleRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetRolesEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetRoles")[0], (int)MonoSoftware.MonoX.DAL.EntityType.CalendarViewRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetRolesEntity, 0, null, null, null, null, "AspnetRoles", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CalendarEntityFactory))),	(IEntityRelation)GetRelationsForField("Calendar")[0], (int)MonoSoftware.MonoX.DAL.EntityType.CalendarViewRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.CalendarEntity, 0, null, null, null, null, "Calendar", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The CalendarId property of the Entity CalendarViewRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "CalendarViewRole"."CalendarId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid CalendarId
		{
			get { return (System.Guid)GetValue((int)CalendarViewRoleFieldIndex.CalendarId, true); }
			set	{ SetValue((int)CalendarViewRoleFieldIndex.CalendarId, value); }
		}

		/// <summary> The RoleId property of the Entity CalendarViewRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "CalendarViewRole"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid RoleId
		{
			get { return (System.Guid)GetValue((int)CalendarViewRoleFieldIndex.RoleId, true); }
			set	{ SetValue((int)CalendarViewRoleFieldIndex.RoleId, value); }
		}
		...
		public virtual AspnetRolesEntity AspnetRoles
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "CalendarViewRoles", "AspnetRoles", _aspnetRoles, true); 
				}
			}
		}
		...
		public virtual CalendarEntity Calendar
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "CalendarViewRoles", "Calendar", _calendar, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.CalendarViewRoleEntity; }
		}
