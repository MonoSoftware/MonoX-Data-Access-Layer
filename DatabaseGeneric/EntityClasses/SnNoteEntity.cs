...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'SnNote'.<br/><br/></summary>
	[Serializable]
	public partial class SnNoteEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private AspnetUsersEntity _aspnetUserAuthor;
		private AspnetUsersEntity _aspnetUserPostedTo;
		...
		public static partial class MemberNames
		{
			...
			/// <summary>Member name AspnetUserAuthor</summary>
			public static readonly string AspnetUserAuthor = "AspnetUserAuthor";
			/// <summary>Member name AspnetUserPostedTo</summary>
			public static readonly string AspnetUserPostedTo = "AspnetUserPostedTo";
		...
		public SnNoteEntity():base("SnNoteEntity")
		{
		...
		public SnNoteEntity(IEntityFields2 fields):base("SnNoteEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this SnNoteEntity</param>
		public SnNoteEntity(IValidator validator):base("SnNoteEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for SnNote which data should be fetched into this SnNote object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnNoteEntity(System.Guid id):base("SnNoteEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this SnNoteEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnNoteEntity(System.Guid id, IValidator validator):base("SnNoteEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		protected SnNoteEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((SnNoteFieldIndex)fieldIndex)
			{
				case SnNoteFieldIndex.ApplicationId:
					DesetupSyncAspnetApplication(true, false);
					break;
				case SnNoteFieldIndex.LanguageId:
					DesetupSyncLanguage(true, false);
					break;
				case SnNoteFieldIndex.UserId:
					DesetupSyncAspnetUserAuthor(true, false);
					break;
				case SnNoteFieldIndex.GroupId:
					DesetupSyncSnGroup(true, false);
					break;
				case SnNoteFieldIndex.PostToUserId:
					DesetupSyncAspnetUserPostedTo(true, false);
					break;
				case SnNoteFieldIndex.PrivacyLevelId:
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				...
				case "AspnetUserAuthor":
					this.AspnetUserAuthor = (AspnetUsersEntity)entity;
					break;
				case "AspnetUserPostedTo":
					this.AspnetUserPostedTo = (AspnetUsersEntity)entity;
					break;
				case "Language":
		...
		protected override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				case "AspnetApplication":
					...
					break;
				case "AspnetUserAuthor":
					SetupSyncAspnetUserAuthor(relatedEntity);
					break;
				case "AspnetUserPostedTo":
					SetupSyncAspnetUserPostedTo(relatedEntity);
					break;
				case "Language":
		...
		protected override List<IEntity2> GetDependentRelatedEntities()
		{
			...
			if(_aspnetUserAuthor!=null)
			{
				toReturn.Add(_aspnetUserAuthor);
			}
			if(_aspnetUserPostedTo!=null)
			{
				toReturn.Add(_aspnetUserPostedTo);
			}
			if(_language!=null)
			{
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SnRelationshipFields.NoteId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("NoteContent", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("PostToUserId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetApplication, new PropertyChangedEventHandler( OnAspnetApplicationPropertyChanged ), "AspnetApplication", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnNoteRelations.AspnetApplicationsEntityUsingApplicationIdStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)SnNoteFieldIndex.ApplicationId } );
		...
		private void SetupSyncAspnetApplication(IEntity2 relatedEntity)
		{
			if(_aspnetApplication!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetApplication, new PropertyChangedEventHandler( OnAspnetApplicationPropertyChanged ), "AspnetApplication", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnNoteRelations.AspnetApplicationsEntityUsingApplicationIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <summary> Removes the sync logic for member _aspnetUserAuthor</summary>
		/// <param name="signalRelatedEntity">If set to true, it will call the related entity's UnsetRelatedEntity method</param>
		/// <param name="resetFKFields">if set to true it will also reset the FK fields pointing to the related entity</param>
		private void DesetupSyncAspnetUserAuthor(bool signalRelatedEntity, bool resetFKFields)
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetUserAuthor, new PropertyChangedEventHandler( OnAspnetUserAuthorPropertyChanged ), "AspnetUserAuthor", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnNoteRelations.AspnetUsersEntityUsingUserIdStatic, true, signalRelatedEntity, "SnNotesPostedTo", resetFKFields, new int[] { (int)SnNoteFieldIndex.UserId } );
			_aspnetUserAuthor = null;
		}

		/// <summary> setups the sync logic for member _aspnetUserAuthor</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncAspnetUserAuthor(IEntity2 relatedEntity)
		{
			if(_aspnetUserAuthor!=relatedEntity)
			{
				DesetupSyncAspnetUserAuthor(true, true);
				_aspnetUserAuthor = (AspnetUsersEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _aspnetUserAuthor, new PropertyChangedEventHandler( OnAspnetUserAuthorPropertyChanged ), "AspnetUserAuthor", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnNoteRelations.AspnetUsersEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void OnAspnetUserAuthorPropertyChanged( object sender, PropertyChangedEventArgs e )
		{
			switch( e.PropertyName )
			{
				default:
		...
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncAspnetUserPostedTo(IEntity2 relatedEntity)
		{
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void OnAspnetUserPostedToPropertyChanged( object sender, PropertyChangedEventArgs e )
		{
			switch( e.PropertyName )
			{
				default:
		...
		{
			this.PerformDesetupSyncRelatedEntity( _language, new PropertyChangedEventHandler( OnLanguagePropertyChanged ), "Language", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnNoteRelations.LanguageEntityUsingLanguageIdStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)SnNoteFieldIndex.LanguageId } );
			_language = null;
		}
		...
		private void SetupSyncLanguage(IEntity2 relatedEntity)
		{
			if(_language!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _language, new PropertyChangedEventHandler( OnLanguagePropertyChanged ), "Language", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnNoteRelations.LanguageEntityUsingLanguageIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _privacyLevel, new PropertyChangedEventHandler( OnPrivacyLevelPropertyChanged ), "PrivacyLevel", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnNoteRelations.PrivacyLevelEntityUsingPrivacyLevelIdStatic, true, signalRelatedEntity, "SnNotes", resetFKFields, new int[] { (int)SnNoteFieldIndex.PrivacyLevelId } );
			_privacyLevel = null;
		}
		...
		private void SetupSyncPrivacyLevel(IEntity2 relatedEntity)
		{
			if(_privacyLevel!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _privacyLevel, new PropertyChangedEventHandler( OnPrivacyLevelPropertyChanged ), "PrivacyLevel", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnNoteRelations.PrivacyLevelEntityUsingPrivacyLevelIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _snGroup, new PropertyChangedEventHandler( OnSnGroupPropertyChanged ), "SnGroup", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnNoteRelations.SnGroupEntityUsingGroupIdStatic, true, signalRelatedEntity, "SnNotes", resetFKFields, new int[] { (int)SnNoteFieldIndex.GroupId } );
			_snGroup = null;
		}
		...
		/// <param name="validator">The validator object for this SnNoteEntity</param>
		...
		public  static SnNoteRelations Relations
		{
			get	{ return new SnNoteRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SnEventEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SnEventEntityFactory))), (IEntityRelation)GetRelationsForField("SnEvents")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnNoteEntity, (int)MonoSoftware.MonoX.DAL.EntityType.SnEventEntity, 0, null, null, null, null, "SnEvents", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SnRelationshipEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SnRelationshipEntityFactory))), (IEntityRelation)GetRelationsForField("SnRelationships")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnNoteEntity, (int)MonoSoftware.MonoX.DAL.EntityType.SnRelationshipEntity, 0, null, null, null, null, "SnRelationships", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetApplicationsEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetApplication")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnNoteEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetApplicationsEntity, 0, null, null, null, null, "AspnetApplication", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathAspnetUserAuthor
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUserAuthor")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnNoteEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUserAuthor", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'AspnetUsers' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathAspnetUserPostedTo
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUserPostedTo")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnNoteEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUserPostedTo", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(LanguageEntityFactory))),	(IEntityRelation)GetRelationsForField("Language")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnNoteEntity, (int)MonoSoftware.MonoX.DAL.EntityType.LanguageEntity, 0, null, null, null, null, "Language", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PrivacyLevelEntityFactory))),	(IEntityRelation)GetRelationsForField("PrivacyLevel")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnNoteEntity, (int)MonoSoftware.MonoX.DAL.EntityType.PrivacyLevelEntity, 0, null, null, null, null, "PrivacyLevel", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SnGroupEntityFactory))),	(IEntityRelation)GetRelationsForField("SnGroup")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnNoteEntity, (int)MonoSoftware.MonoX.DAL.EntityType.SnGroupEntity, 0, null, null, null, null, "SnGroup", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)SnNoteFieldIndex.Id, true); }
			set	{ SetValue((int)SnNoteFieldIndex.Id, value); }
		}

		/// <summary> The ApplicationId property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."ApplicationId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid ApplicationId
		{
			get { return (System.Guid)GetValue((int)SnNoteFieldIndex.ApplicationId, true); }
			set	{ SetValue((int)SnNoteFieldIndex.ApplicationId, value); }
		}

		/// <summary> The LanguageId property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."LanguageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid LanguageId
		{
			get { return (System.Guid)GetValue((int)SnNoteFieldIndex.LanguageId, true); }
			set	{ SetValue((int)SnNoteFieldIndex.LanguageId, value); }
		}

		/// <summary> The UserId property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid UserId
		{
			get { return (System.Guid)GetValue((int)SnNoteFieldIndex.UserId, true); }
			set	{ SetValue((int)SnNoteFieldIndex.UserId, value); }
		}

		/// <summary> The GroupId property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."GroupId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Guid> GroupId
		{
			get { return (Nullable<System.Guid>)GetValue((int)SnNoteFieldIndex.GroupId, false); }
			set	{ SetValue((int)SnNoteFieldIndex.GroupId, value); }
		}

		/// <summary> The NoteContent property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."NoteContent"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String NoteContent
		{
			get { return (System.String)GetValue((int)SnNoteFieldIndex.NoteContent, true); }
			set	{ SetValue((int)SnNoteFieldIndex.NoteContent, value); }
		}

		/// <summary> The DateCreated property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)SnNoteFieldIndex.DateCreated, true); }
			set	{ SetValue((int)SnNoteFieldIndex.DateCreated, value); }
		}

		/// <summary> The Title property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."Title"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Title
		{
			get { return (System.String)GetValue((int)SnNoteFieldIndex.Title, true); }
			set	{ SetValue((int)SnNoteFieldIndex.Title, value); }
		}

		/// <summary> The Rating property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."Rating"<br/>
		/// Table field type characteristics (type, precision, scale, length): Float, 38, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Double Rating
		{
			get { return (System.Double)GetValue((int)SnNoteFieldIndex.Rating, true); }
			set	{ SetValue((int)SnNoteFieldIndex.Rating, value); }
		}

		/// <summary> The PostToUserId property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."PostToUserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Guid> PostToUserId
		{
			get { return (Nullable<System.Guid>)GetValue((int)SnNoteFieldIndex.PostToUserId, false); }
			set	{ SetValue((int)SnNoteFieldIndex.PostToUserId, value); }
		}

		/// <summary> The PrivacyLevelId property of the Entity SnNote<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnNote"."PrivacyLevelId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.Guid> PrivacyLevelId
		{
			get { return (Nullable<System.Guid>)GetValue((int)SnNoteFieldIndex.PrivacyLevelId, false); }
			set	{ SetValue((int)SnNoteFieldIndex.PrivacyLevelId, value); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<SnEventEntity, SnEventEntityFactory>("SnNote", true, false, ref _snEvents);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<SnRelationshipEntity, SnRelationshipEntityFactory>("SnNote", true, false, ref _snRelationships);	}
		}
		...
		[Browsable(true)]
		public virtual AspnetUsersEntity AspnetUserAuthor
		{
			get	{ return _aspnetUserAuthor; }
			set
			{
				if(this.IsDeserializing)
				{
					SetupSyncAspnetUserAuthor(value);
				}
				else
				{
					SetSingleRelatedEntityNavigator(value, "SnNotesPostedTo", "AspnetUserAuthor", _aspnetUserAuthor, true); 
				}
			}
		}
		...
		/// <summary> Gets / sets related entity of type 'AspnetUsersEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned..<br/><br/></summary>
		[Browsable(true)]
		public virtual AspnetUsersEntity AspnetUserPostedTo
		{
			get	{ return _aspnetUserPostedTo; }
			set
			{
				if(this.IsDeserializing)
				{
					SetupSyncAspnetUserPostedTo(value);
				}
				else
				{
					SetSingleRelatedEntityNavigator(value, "SnNotesAuthoredBy", "AspnetUserPostedTo", _aspnetUserPostedTo, true); 
				}
			}
		}
		...
		public virtual PrivacyLevelEntity PrivacyLevel
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "SnNotes", "PrivacyLevel", _privacyLevel, true); 
				}
			}
		}
		...
		public virtual SnGroupEntity SnGroup
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "SnNotes", "SnGroup", _snGroup, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.SnNoteEntity; }
		}
