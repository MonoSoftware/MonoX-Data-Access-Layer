...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AspnetApplications'.<br/><br/></summary>
	[Serializable]
	public partial class AspnetApplicationsEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static AspnetApplicationsEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public AspnetApplicationsEntity():base("AspnetApplicationsEntity")
		{
		...
		public AspnetApplicationsEntity(IEntityFields2 fields):base("AspnetApplicationsEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this AspnetApplicationsEntity</param>
		public AspnetApplicationsEntity(IValidator validator):base("AspnetApplicationsEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="applicationId">PK value for AspnetApplications which data should be fetched into this AspnetApplications object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AspnetApplicationsEntity(System.Guid applicationId):base("AspnetApplicationsEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this AspnetApplicationsEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AspnetApplicationsEntity(System.Guid applicationId, IValidator validator):base("AspnetApplicationsEntity")
		{
			InitClassEmpty(validator, null);
			this.ApplicationId = applicationId;
		}
		...
		protected AspnetApplicationsEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		/// <summary> Method which will construct a filter (predicate expression) for the unique constraint defined on the fields:
		/// LoweredApplicationName .</summary>
		/// <returns>true if succeeded and the contents is read, false otherwise</returns>
		...
		{
			return new AspnetApplicationsRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(AspnetApplicationsEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("LoweredApplicationName", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this AspnetApplicationsEntity</param>
		...
		public  static AspnetApplicationsRelations Relations
		{
			get	{ return new AspnetApplicationsRelations(); }
		}
		...
		public virtual System.String ApplicationName
		{
			...
			set	{ SetValue((int)AspnetApplicationsFieldIndex.ApplicationName, value); }
		}
		...
		public virtual System.String LoweredApplicationName
		{
			...
			set	{ SetValue((int)AspnetApplicationsFieldIndex.LoweredApplicationName, value); }
		}
		...
		public virtual System.Guid ApplicationId
		{
			...
			set	{ SetValue((int)AspnetApplicationsFieldIndex.ApplicationId, value); }
		}
		...
		public virtual System.String Description
		{
			...
			set	{ SetValue((int)AspnetApplicationsFieldIndex.Description, value); }
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.AspnetApplicationsEntity; }
		}
