...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'CalendarModerator'.<br/><br/></summary>
	[Serializable]
	public partial class CalendarModeratorEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static CalendarModeratorEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public CalendarModeratorEntity():base("CalendarModeratorEntity")
		{
		...
		public CalendarModeratorEntity(IEntityFields2 fields):base("CalendarModeratorEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this CalendarModeratorEntity</param>
		public CalendarModeratorEntity(IValidator validator):base("CalendarModeratorEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="calendarId">PK value for CalendarModerator which data should be fetched into this CalendarModerator object</param>
		/// <param name="userId">PK value for CalendarModerator which data should be fetched into this CalendarModerator object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CalendarModeratorEntity(System.Guid calendarId, System.Guid userId):base("CalendarModeratorEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this CalendarModeratorEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CalendarModeratorEntity(System.Guid calendarId, System.Guid userId, IValidator validator):base("CalendarModeratorEntity")
		{
			InitClassEmpty(validator, null);
			this.CalendarId = calendarId;
			this.UserId = userId;
		...
		protected CalendarModeratorEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((CalendarModeratorFieldIndex)fieldIndex)
			{
				case CalendarModeratorFieldIndex.CalendarId:
					DesetupSyncCalendar(true, false);
					break;
				case CalendarModeratorFieldIndex.UserId:
		...
		{
			return new CalendarModeratorRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(CalendarModeratorEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetUsers, new PropertyChangedEventHandler( OnAspnetUsersPropertyChanged ), "AspnetUsers", MonoSoftware.MonoX.DAL.RelationClasses.StaticCalendarModeratorRelations.AspnetUsersEntityUsingUserIdStatic, true, signalRelatedEntity, "CalendarModerators", resetFKFields, new int[] { (int)CalendarModeratorFieldIndex.UserId } );
			_aspnetUsers = null;
		}
		...
		private void SetupSyncAspnetUsers(IEntityCore relatedEntity)
		{
			if(_aspnetUsers!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetUsers, new PropertyChangedEventHandler( OnAspnetUsersPropertyChanged ), "AspnetUsers", MonoSoftware.MonoX.DAL.RelationClasses.StaticCalendarModeratorRelations.AspnetUsersEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _calendar, new PropertyChangedEventHandler( OnCalendarPropertyChanged ), "Calendar", MonoSoftware.MonoX.DAL.RelationClasses.StaticCalendarModeratorRelations.CalendarEntityUsingCalendarIdStatic, true, signalRelatedEntity, "CalendarModerators", resetFKFields, new int[] { (int)CalendarModeratorFieldIndex.CalendarId } );
			_calendar = null;
		}
		...
		private void SetupSyncCalendar(IEntityCore relatedEntity)
		{
			if(_calendar!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _calendar, new PropertyChangedEventHandler( OnCalendarPropertyChanged ), "Calendar", MonoSoftware.MonoX.DAL.RelationClasses.StaticCalendarModeratorRelations.CalendarEntityUsingCalendarIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this CalendarModeratorEntity</param>
		...
		public  static CalendarModeratorRelations Relations
		{
			get	{ return new CalendarModeratorRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUsers")[0], (int)MonoSoftware.MonoX.DAL.EntityType.CalendarModeratorEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUsers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CalendarEntityFactory))),	(IEntityRelation)GetRelationsForField("Calendar")[0], (int)MonoSoftware.MonoX.DAL.EntityType.CalendarModeratorEntity, (int)MonoSoftware.MonoX.DAL.EntityType.CalendarEntity, 0, null, null, null, null, "Calendar", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The CalendarId property of the Entity CalendarModerator<br/><br/></summary>
		/// <remarks>Mapped on  table field: "CalendarModerator"."CalendarId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>		
		public virtual System.Guid CalendarId
		{
			get { return (System.Guid)GetValue((int)CalendarModeratorFieldIndex.CalendarId, true); }
			set	{ SetValue((int)CalendarModeratorFieldIndex.CalendarId, value); }
		}

		/// <summary> The UserId property of the Entity CalendarModerator<br/><br/></summary>
		/// <remarks>Mapped on  table field: "CalendarModerator"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>		
		public virtual System.Guid UserId
		{
			get { return (System.Guid)GetValue((int)CalendarModeratorFieldIndex.UserId, true); }
			set	{ SetValue((int)CalendarModeratorFieldIndex.UserId, value); }
		}
		...
		public virtual AspnetUsersEntity AspnetUsers
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "CalendarModerators", "AspnetUsers", _aspnetUsers, true); 
				}
			}
		}
		...
		public virtual CalendarEntity Calendar
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "CalendarModerators", "Calendar", _calendar, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.CalendarModeratorEntity; }
		}
