...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'BlogPostRole'.<br/><br/></summary>
	[Serializable]
	public partial class BlogPostRoleEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static BlogPostRoleEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public BlogPostRoleEntity():base("BlogPostRoleEntity")
		{
		...
		public BlogPostRoleEntity(IEntityFields2 fields):base("BlogPostRoleEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this BlogPostRoleEntity</param>
		public BlogPostRoleEntity(IValidator validator):base("BlogPostRoleEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for BlogPostRole which data should be fetched into this BlogPostRole object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BlogPostRoleEntity(System.Guid id):base("BlogPostRoleEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this BlogPostRoleEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BlogPostRoleEntity(System.Guid id, IValidator validator):base("BlogPostRoleEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		{
			switch((BlogPostRoleFieldIndex)fieldIndex)
			{
				case BlogPostRoleFieldIndex.BlogPostId:
					DesetupSyncBlogPost(true, false);
					break;
				case BlogPostRoleFieldIndex.RoleId:
		...
		{
			return new BlogPostRoleRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(BlogPostRoleEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetRole, new PropertyChangedEventHandler( OnAspnetRolePropertyChanged ), "AspnetRole", MonoSoftware.MonoX.DAL.RelationClasses.StaticBlogPostRoleRelations.AspnetRolesEntityUsingRoleIdStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)BlogPostRoleFieldIndex.RoleId } );
			_aspnetRole = null;
		}
		...
		private void SetupSyncAspnetRole(IEntityCore relatedEntity)
		{
			if(_aspnetRole!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetRole, new PropertyChangedEventHandler( OnAspnetRolePropertyChanged ), "AspnetRole", MonoSoftware.MonoX.DAL.RelationClasses.StaticBlogPostRoleRelations.AspnetRolesEntityUsingRoleIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _blogPost, new PropertyChangedEventHandler( OnBlogPostPropertyChanged ), "BlogPost", MonoSoftware.MonoX.DAL.RelationClasses.StaticBlogPostRoleRelations.BlogPostEntityUsingBlogPostIdStatic, true, signalRelatedEntity, "BlogPostRoles", resetFKFields, new int[] { (int)BlogPostRoleFieldIndex.BlogPostId } );
			_blogPost = null;
		}
		...
		private void SetupSyncBlogPost(IEntityCore relatedEntity)
		{
			if(_blogPost!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _blogPost, new PropertyChangedEventHandler( OnBlogPostPropertyChanged ), "BlogPost", MonoSoftware.MonoX.DAL.RelationClasses.StaticBlogPostRoleRelations.BlogPostEntityUsingBlogPostIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this BlogPostRoleEntity</param>
		...
		public  static BlogPostRoleRelations Relations
		{
			get	{ return new BlogPostRoleRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetRolesEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetRole")[0], (int)MonoSoftware.MonoX.DAL.EntityType.BlogPostRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetRolesEntity, 0, null, null, null, null, "AspnetRole", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(BlogPostEntityFactory))),	(IEntityRelation)GetRelationsForField("BlogPost")[0], (int)MonoSoftware.MonoX.DAL.EntityType.BlogPostRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.BlogPostEntity, 0, null, null, null, null, "BlogPost", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity BlogPostRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "BlogPostRole"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>		
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)BlogPostRoleFieldIndex.Id, true); }
			set	{ SetValue((int)BlogPostRoleFieldIndex.Id, value); }
		}

		/// <summary> The BlogPostId property of the Entity BlogPostRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "BlogPostRole"."BlogPostId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>		
		public virtual System.Guid BlogPostId
		{
			get { return (System.Guid)GetValue((int)BlogPostRoleFieldIndex.BlogPostId, true); }
			set	{ SetValue((int)BlogPostRoleFieldIndex.BlogPostId, value); }
		}

		/// <summary> The RoleId property of the Entity BlogPostRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "BlogPostRole"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>		
		public virtual System.Guid RoleId
		{
			get { return (System.Guid)GetValue((int)BlogPostRoleFieldIndex.RoleId, true); }
			set	{ SetValue((int)BlogPostRoleFieldIndex.RoleId, value); }
		}
		...
		public virtual BlogPostEntity BlogPost
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "BlogPostRoles", "BlogPost", _blogPost, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.BlogPostRoleEntity; }
		}
