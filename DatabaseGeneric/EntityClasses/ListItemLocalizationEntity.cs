...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ListItemLocalization'.<br/><br/></summary>
	[Serializable]
	public partial class ListItemLocalizationEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ListItemLocalizationEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public ListItemLocalizationEntity():base("ListItemLocalizationEntity")
		{
		...
		public ListItemLocalizationEntity(IEntityFields2 fields):base("ListItemLocalizationEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ListItemLocalizationEntity</param>
		public ListItemLocalizationEntity(IValidator validator):base("ListItemLocalizationEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for ListItemLocalization which data should be fetched into this ListItemLocalization object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ListItemLocalizationEntity(System.Guid id):base("ListItemLocalizationEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this ListItemLocalizationEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ListItemLocalizationEntity(System.Guid id, IValidator validator):base("ListItemLocalizationEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		protected ListItemLocalizationEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ListItemLocalizationFieldIndex)fieldIndex)
			{
				case ListItemLocalizationFieldIndex.ListItemId:
					DesetupSyncListItem(true, false);
					break;
				case ListItemLocalizationFieldIndex.LanguageId:
		...
		{
			return new ListItemLocalizationRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ListItemLocalizationEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ItemTitle", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ItemContent", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ItemUrl", fieldHashtable);
		}
		#endregion
		...
		{
			this.PerformDesetupSyncRelatedEntity( _language, new PropertyChangedEventHandler( OnLanguagePropertyChanged ), "Language", MonoSoftware.MonoX.DAL.RelationClasses.StaticListItemLocalizationRelations.LanguageEntityUsingLanguageIdStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)ListItemLocalizationFieldIndex.LanguageId } );
			_language = null;
		}
		...
		private void SetupSyncLanguage(IEntityCore relatedEntity)
		{
			if(_language!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _language, new PropertyChangedEventHandler( OnLanguagePropertyChanged ), "Language", MonoSoftware.MonoX.DAL.RelationClasses.StaticListItemLocalizationRelations.LanguageEntityUsingLanguageIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _listItem, new PropertyChangedEventHandler( OnListItemPropertyChanged ), "ListItem", MonoSoftware.MonoX.DAL.RelationClasses.StaticListItemLocalizationRelations.ListItemEntityUsingListItemIdStatic, true, signalRelatedEntity, "ListItemLocalizations", resetFKFields, new int[] { (int)ListItemLocalizationFieldIndex.ListItemId } );
			_listItem = null;
		}
		...
		private void SetupSyncListItem(IEntityCore relatedEntity)
		{
			if(_listItem!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _listItem, new PropertyChangedEventHandler( OnListItemPropertyChanged ), "ListItem", MonoSoftware.MonoX.DAL.RelationClasses.StaticListItemLocalizationRelations.ListItemEntityUsingListItemIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this ListItemLocalizationEntity</param>
		...
		public  static ListItemLocalizationRelations Relations
		{
			get	{ return new ListItemLocalizationRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(LanguageEntityFactory))),	(IEntityRelation)GetRelationsForField("Language")[0], (int)MonoSoftware.MonoX.DAL.EntityType.ListItemLocalizationEntity, (int)MonoSoftware.MonoX.DAL.EntityType.LanguageEntity, 0, null, null, null, null, "Language", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual System.Guid Id
		{
			...
			set	{ SetValue((int)ListItemLocalizationFieldIndex.Id, value); }
		}
		...
		public virtual System.Guid ListItemId
		{
			...
			set	{ SetValue((int)ListItemLocalizationFieldIndex.ListItemId, value); }
		}
		...
		public virtual System.Guid LanguageId
		{
			...
			set	{ SetValue((int)ListItemLocalizationFieldIndex.LanguageId, value); }
		}
		...
		public virtual System.String ItemTitle
		{
			...
			set	{ SetValue((int)ListItemLocalizationFieldIndex.ItemTitle, value); }
		}
		...
		public virtual System.String ItemContent
		{
			...
			set	{ SetValue((int)ListItemLocalizationFieldIndex.ItemContent, value); }
		}
		...
		public virtual System.String ItemUrl
		{
			...
			set	{ SetValue((int)ListItemLocalizationFieldIndex.ItemUrl, value); }
		}
		...
		public virtual ListItemEntity ListItem
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ListItemLocalizations", "ListItem", _listItem, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.ListItemLocalizationEntity; }
		}
