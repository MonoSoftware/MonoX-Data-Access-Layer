...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'SnDiscussionBoardInRole'.<br/><br/></summary>
	[Serializable]
	public partial class SnDiscussionBoardInRoleEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static SnDiscussionBoardInRoleEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public SnDiscussionBoardInRoleEntity():base("SnDiscussionBoardInRoleEntity")
		{
		...
		public SnDiscussionBoardInRoleEntity(IEntityFields2 fields):base("SnDiscussionBoardInRoleEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this SnDiscussionBoardInRoleEntity</param>
		public SnDiscussionBoardInRoleEntity(IValidator validator):base("SnDiscussionBoardInRoleEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="boardId">PK value for SnDiscussionBoardInRole which data should be fetched into this SnDiscussionBoardInRole object</param>
		/// <param name="roleId">PK value for SnDiscussionBoardInRole which data should be fetched into this SnDiscussionBoardInRole object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnDiscussionBoardInRoleEntity(System.Guid boardId, System.Guid roleId):base("SnDiscussionBoardInRoleEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this SnDiscussionBoardInRoleEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnDiscussionBoardInRoleEntity(System.Guid boardId, System.Guid roleId, IValidator validator):base("SnDiscussionBoardInRoleEntity")
		{
			InitClassEmpty(validator, null);
			this.BoardId = boardId;
			this.RoleId = roleId;
		...
		protected SnDiscussionBoardInRoleEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((SnDiscussionBoardInRoleFieldIndex)fieldIndex)
			{
				case SnDiscussionBoardInRoleFieldIndex.BoardId:
					DesetupSyncSnDiscussionBoard(true, false);
					break;
				case SnDiscussionBoardInRoleFieldIndex.RoleId:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "AspnetRole":
					...
					break;
				case "SnDiscussionBoard":
					toReturn.Add(Relations.SnDiscussionBoardEntityUsingBoardId);
					break;
				default:
					break;				
			}
		...
		{
			return new SnDiscussionBoardInRoleRelations().GetAllRelations();
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SnDiscussionBoardFields.Id, null, ComparisonOperator.Equal, this.BoardId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SnDiscussionBoardInRoleEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("BoardId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		private void SetupSyncAspnetRole(IEntity2 relatedEntity)
		{
			if(_aspnetRole!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetRole, new PropertyChangedEventHandler( OnAspnetRolePropertyChanged ), "AspnetRole", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnDiscussionBoardInRoleRelations.AspnetRolesEntityUsingRoleIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _snDiscussionBoard, new PropertyChangedEventHandler( OnSnDiscussionBoardPropertyChanged ), "SnDiscussionBoard", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnDiscussionBoardInRoleRelations.SnDiscussionBoardEntityUsingBoardIdStatic, true, signalRelatedEntity, "SnDiscussionBoardInRoles", resetFKFields, new int[] { (int)SnDiscussionBoardInRoleFieldIndex.BoardId } );
		...
		private void SetupSyncSnDiscussionBoard(IEntity2 relatedEntity)
		{
			if(_snDiscussionBoard!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _snDiscussionBoard, new PropertyChangedEventHandler( OnSnDiscussionBoardPropertyChanged ), "SnDiscussionBoard", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnDiscussionBoardInRoleRelations.SnDiscussionBoardEntityUsingBoardIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this SnDiscussionBoardInRoleEntity</param>
		...
		public  static SnDiscussionBoardInRoleRelations Relations
		{
			get	{ return new SnDiscussionBoardInRoleRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetRolesEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetRole")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnDiscussionBoardInRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetRolesEntity, 0, null, null, null, null, "AspnetRole", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SnDiscussionBoardEntityFactory))),	(IEntityRelation)GetRelationsForField("SnDiscussionBoard")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnDiscussionBoardInRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.SnDiscussionBoardEntity, 0, null, null, null, null, "SnDiscussionBoard", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The BoardId property of the Entity SnDiscussionBoardInRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnDiscussionBoardInRole"."BoardId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid BoardId
		{
			get { return (System.Guid)GetValue((int)SnDiscussionBoardInRoleFieldIndex.BoardId, true); }
			set	{ SetValue((int)SnDiscussionBoardInRoleFieldIndex.BoardId, value); }
		}

		/// <summary> The RoleId property of the Entity SnDiscussionBoardInRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnDiscussionBoardInRole"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid RoleId
		{
			get { return (System.Guid)GetValue((int)SnDiscussionBoardInRoleFieldIndex.RoleId, true); }
			set	{ SetValue((int)SnDiscussionBoardInRoleFieldIndex.RoleId, value); }
		}
		...
		public virtual SnDiscussionBoardEntity SnDiscussionBoard
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "SnDiscussionBoardInRoles", "SnDiscussionBoard", _snDiscussionBoard, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.SnDiscussionBoardInRoleEntity; }
		}
