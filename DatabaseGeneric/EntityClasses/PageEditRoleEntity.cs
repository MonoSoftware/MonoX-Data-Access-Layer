...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'PageEditRole'.<br/><br/></summary>
	[Serializable]
	public partial class PageEditRoleEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static PageEditRoleEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public PageEditRoleEntity():base("PageEditRoleEntity")
		{
		...
		public PageEditRoleEntity(IEntityFields2 fields):base("PageEditRoleEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this PageEditRoleEntity</param>
		public PageEditRoleEntity(IValidator validator):base("PageEditRoleEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for PageEditRole which data should be fetched into this PageEditRole object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PageEditRoleEntity(System.Guid id):base("PageEditRoleEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this PageEditRoleEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PageEditRoleEntity(System.Guid id, IValidator validator):base("PageEditRoleEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		{
			switch((PageEditRoleFieldIndex)fieldIndex)
			{
				case PageEditRoleFieldIndex.PageId:
					DesetupSyncPage(true, false);
					break;
				case PageEditRoleFieldIndex.RoleId:
		...
		{
			return new PageEditRoleRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(PageEditRoleEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetRole, new PropertyChangedEventHandler( OnAspnetRolePropertyChanged ), "AspnetRole", MonoSoftware.MonoX.DAL.RelationClasses.StaticPageEditRoleRelations.AspnetRolesEntityUsingRoleIdStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)PageEditRoleFieldIndex.RoleId } );
			_aspnetRole = null;
		}
		...
		private void SetupSyncAspnetRole(IEntity2 relatedEntity)
		{
			if(_aspnetRole!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetRole, new PropertyChangedEventHandler( OnAspnetRolePropertyChanged ), "AspnetRole", MonoSoftware.MonoX.DAL.RelationClasses.StaticPageEditRoleRelations.AspnetRolesEntityUsingRoleIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _page, new PropertyChangedEventHandler( OnPagePropertyChanged ), "Page", MonoSoftware.MonoX.DAL.RelationClasses.StaticPageEditRoleRelations.PageEntityUsingPageIdStatic, true, signalRelatedEntity, "PageEditRoles", resetFKFields, new int[] { (int)PageEditRoleFieldIndex.PageId } );
			_page = null;
		}
		...
		private void SetupSyncPage(IEntity2 relatedEntity)
		{
			if(_page!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _page, new PropertyChangedEventHandler( OnPagePropertyChanged ), "Page", MonoSoftware.MonoX.DAL.RelationClasses.StaticPageEditRoleRelations.PageEntityUsingPageIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this PageEditRoleEntity</param>
		...
		public  static PageEditRoleRelations Relations
		{
			get	{ return new PageEditRoleRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetRolesEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetRole")[0], (int)MonoSoftware.MonoX.DAL.EntityType.PageEditRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetRolesEntity, 0, null, null, null, null, "AspnetRole", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PageEntityFactory))),	(IEntityRelation)GetRelationsForField("Page")[0], (int)MonoSoftware.MonoX.DAL.EntityType.PageEditRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.PageEntity, 0, null, null, null, null, "Page", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity PageEditRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PageEditRole"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)PageEditRoleFieldIndex.Id, true); }
			set	{ SetValue((int)PageEditRoleFieldIndex.Id, value); }
		}

		/// <summary> The PageId property of the Entity PageEditRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PageEditRole"."PageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid PageId
		{
			get { return (System.Guid)GetValue((int)PageEditRoleFieldIndex.PageId, true); }
			set	{ SetValue((int)PageEditRoleFieldIndex.PageId, value); }
		}

		/// <summary> The RoleId property of the Entity PageEditRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PageEditRole"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid RoleId
		{
			get { return (System.Guid)GetValue((int)PageEditRoleFieldIndex.RoleId, true); }
			set	{ SetValue((int)PageEditRoleFieldIndex.RoleId, value); }
		}
		...
		public virtual PageEntity Page
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "PageEditRoles", "Page", _page, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.PageEditRoleEntity; }
		}
