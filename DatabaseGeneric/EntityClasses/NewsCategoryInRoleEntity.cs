...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'NewsCategoryInRole'.<br/><br/></summary>
	[Serializable]
	public partial class NewsCategoryInRoleEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static NewsCategoryInRoleEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public NewsCategoryInRoleEntity():base("NewsCategoryInRoleEntity")
		{
		...
		public NewsCategoryInRoleEntity(IEntityFields2 fields):base("NewsCategoryInRoleEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this NewsCategoryInRoleEntity</param>
		public NewsCategoryInRoleEntity(IValidator validator):base("NewsCategoryInRoleEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for NewsCategoryInRole which data should be fetched into this NewsCategoryInRole object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NewsCategoryInRoleEntity(System.Guid id):base("NewsCategoryInRoleEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this NewsCategoryInRoleEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NewsCategoryInRoleEntity(System.Guid id, IValidator validator):base("NewsCategoryInRoleEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		protected NewsCategoryInRoleEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((NewsCategoryInRoleFieldIndex)fieldIndex)
			{
				case NewsCategoryInRoleFieldIndex.NewsCategoryId:
					DesetupSyncNewsCategory(true, false);
					break;
				case NewsCategoryInRoleFieldIndex.RoleId:
		...
		{
			return new NewsCategoryInRoleRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(NewsCategoryInRoleEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ViewPermissions", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EditPermissions", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _newsCategory, new PropertyChangedEventHandler( OnNewsCategoryPropertyChanged ), "NewsCategory", MonoSoftware.MonoX.DAL.RelationClasses.StaticNewsCategoryInRoleRelations.NewsCategoryEntityUsingNewsCategoryIdStatic, true, signalRelatedEntity, "NewsCategoryInRoles", resetFKFields, new int[] { (int)NewsCategoryInRoleFieldIndex.NewsCategoryId } );
			_newsCategory = null;
		}
		...
		private void SetupSyncNewsCategory(IEntityCore relatedEntity)
		{
			if(_newsCategory!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _newsCategory, new PropertyChangedEventHandler( OnNewsCategoryPropertyChanged ), "NewsCategory", MonoSoftware.MonoX.DAL.RelationClasses.StaticNewsCategoryInRoleRelations.NewsCategoryEntityUsingNewsCategoryIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this NewsCategoryInRoleEntity</param>
		...
		public  static NewsCategoryInRoleRelations Relations
		{
			get	{ return new NewsCategoryInRoleRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetRolesEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetRole")[0], (int)MonoSoftware.MonoX.DAL.EntityType.NewsCategoryInRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetRolesEntity, 0, null, null, null, null, "AspnetRole", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(NewsCategoryEntityFactory))),	(IEntityRelation)GetRelationsForField("NewsCategory")[0], (int)MonoSoftware.MonoX.DAL.EntityType.NewsCategoryInRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.NewsCategoryEntity, 0, null, null, null, null, "NewsCategory", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual System.Guid Id
		{
			...
			set	{ SetValue((int)NewsCategoryInRoleFieldIndex.Id, value); }
		}
		...
		public virtual System.Guid NewsCategoryId
		{
			...
			set	{ SetValue((int)NewsCategoryInRoleFieldIndex.NewsCategoryId, value); }
		}
		...
		public virtual System.Guid RoleId
		{
			...
			set	{ SetValue((int)NewsCategoryInRoleFieldIndex.RoleId, value); }
		}
		...
		public virtual System.Boolean ViewPermissions
		{
			...
			set	{ SetValue((int)NewsCategoryInRoleFieldIndex.ViewPermissions, value); }
		}
		...
		public virtual System.Boolean EditPermissions
		{
			...
			set	{ SetValue((int)NewsCategoryInRoleFieldIndex.EditPermissions, value); }
		}
		...
		public virtual Nullable<System.DateTime> DateEntered
		{
			...
			set	{ SetValue((int)NewsCategoryInRoleFieldIndex.DateEntered, value); }
		}
		...
		public virtual Nullable<System.DateTime> DateModified
		{
			...
			set	{ SetValue((int)NewsCategoryInRoleFieldIndex.DateModified, value); }
		}
		...
		public virtual NewsCategoryEntity NewsCategory
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "NewsCategoryInRoles", "NewsCategory", _newsCategory, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.NewsCategoryInRoleEntity; }
		}
