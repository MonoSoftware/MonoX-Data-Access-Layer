...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'SnMessage'.<br/><br/></summary>
	[Serializable]
	public partial class SnMessageEntity : CommonEntityBase
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfaces
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private EntityCollection<SnMessageEntity> _snReplyMessages;
		...
		public static partial class MemberNames
		{
			...
			/// <summary>Member name SnReplyMessages</summary>
			public static readonly string SnReplyMessages = "SnReplyMessages";
		...
		static SnMessageEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public SnMessageEntity():base("SnMessageEntity")
		{
		...
		public SnMessageEntity(IEntityFields2 fields):base("SnMessageEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this SnMessageEntity</param>
		public SnMessageEntity(IValidator validator):base("SnMessageEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for SnMessage which data should be fetched into this SnMessage object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnMessageEntity(System.Guid id):base("SnMessageEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this SnMessageEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnMessageEntity(System.Guid id, IValidator validator):base("SnMessageEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		protected SnMessageEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				_snReplyMessages = (EntityCollection<SnMessageEntity>)info.GetValue("_snReplyMessages", typeof(EntityCollection<SnMessageEntity>));
		...
		{
			switch((SnMessageFieldIndex)fieldIndex)
			{
				case SnMessageFieldIndex.UserId:
					DesetupSyncAspnetUser(true, false);
					break;
				case SnMessageFieldIndex.InReplyToMessageId:
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntity2 entity)
		{
			switch(propertyName)
			{
				...
				case "SnMessage":
					...
					break;
				case "SnReplyMessages":
					this.SnReplyMessages.Add((SnMessageEntity)entity);
					break;
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "AspnetUser":
					...
					break;
				case "SnMessage":
					toReturn.Add(Relations.SnMessageEntityUsingIdInReplyToMessageId);
					break;
				case "SnReplyMessages":
					toReturn.Add(Relations.SnMessageEntityUsingInReplyToMessageId);
					break;
				case "SnMessageRecipients":
					toReturn.Add(Relations.SnMessageRecipientEntityUsingMessageId);
					break;
				case "SnRelationships":
					toReturn.Add(Relations.SnRelationshipEntityUsingMessageId);
					break;
				default:
					break;				
			}
		...
		protected override void SetRelatedEntity(IEntity2 relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "SnMessage":
					...
					break;
				case "SnReplyMessages":
					this.SnReplyMessages.Add((SnMessageEntity)relatedEntity);
					break;
				case "SnMessageRecipients":
		...
		protected override void UnsetRelatedEntity(IEntity2 relatedEntity, string fieldName, bool signalRelatedEntityManyToOne)
		{
			switch(fieldName)
			{
				...
				case "SnMessage":
					...
					break;
				case "SnReplyMessages":
					this.PerformRelatedEntityRemoval(this.SnReplyMessages, relatedEntity, signalRelatedEntityManyToOne);
					break;
				case "SnMessageRecipients":
		...
		protected override List<IEntityCollection2> GetMemberEntityCollections()
		{
			...
			toReturn.Add(this.SnReplyMessages);
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				info.AddValue("_snReplyMessages", ((_snReplyMessages!=null) && (_snReplyMessages.Count>0) && !this.MarkedForDeletion)?_snReplyMessages:null);
		...
		{
			return new SnMessageRelations().GetAllRelations();
		}
		...
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoSnReplyMessages()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SnMessageFields.InReplyToMessageId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SnMessageRecipientFields.MessageId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SnRelationshipFields.MessageId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(SnMessageFields.Id, null, ComparisonOperator.Equal, this.InReplyToMessageId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SnMessageEntityFactory));
		}
#if !CF
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._snReplyMessages);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._snReplyMessages = (EntityCollection<SnMessageEntity>) collectionsQueue.Dequeue();
		...
		{
			bool toReturn = false;
			toReturn |=(this._snReplyMessages != null);
		...
		protected override Dictionary<string, object> GetRelatedData()
		{
			...
			toReturn.Add("SnReplyMessages", _snReplyMessages);
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("InReplyToMessageId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetUser, new PropertyChangedEventHandler( OnAspnetUserPropertyChanged ), "AspnetUser", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnMessageRelations.AspnetUsersEntityUsingUserIdStatic, true, signalRelatedEntity, "SnMessages", resetFKFields, new int[] { (int)SnMessageFieldIndex.UserId } );
			_aspnetUser = null;
		}
		...
		private void SetupSyncAspnetUser(IEntity2 relatedEntity)
		{
			if(_aspnetUser!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetUser, new PropertyChangedEventHandler( OnAspnetUserPropertyChanged ), "AspnetUser", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnMessageRelations.AspnetUsersEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _snMessage, new PropertyChangedEventHandler( OnSnMessagePropertyChanged ), "SnMessage", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnMessageRelations.SnMessageEntityUsingIdInReplyToMessageIdStatic, true, signalRelatedEntity, "SnReplyMessages", resetFKFields, new int[] { (int)SnMessageFieldIndex.InReplyToMessageId } );
			_snMessage = null;
		}
		...
		private void SetupSyncSnMessage(IEntity2 relatedEntity)
		{
			if(_snMessage!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _snMessage, new PropertyChangedEventHandler( OnSnMessagePropertyChanged ), "SnMessage", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnMessageRelations.SnMessageEntityUsingIdInReplyToMessageIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this SnMessageEntity</param>
		...
		public  static SnMessageRelations Relations
		{
			get	{ return new SnMessageRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathSnReplyMessages
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SnMessageEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SnMessageEntityFactory))), (IEntityRelation)GetRelationsForField("SnReplyMessages")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnMessageEntity, (int)MonoSoftware.MonoX.DAL.EntityType.SnMessageEntity, 0, null, null, null, null, "SnReplyMessages", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<SnRelationshipEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SnRelationshipEntityFactory))), (IEntityRelation)GetRelationsForField("SnRelationships")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnMessageEntity, (int)MonoSoftware.MonoX.DAL.EntityType.SnRelationshipEntity, 0, null, null, null, null, "SnRelationships", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUser")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnMessageEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SnMessageEntityFactory))),	(IEntityRelation)GetRelationsForField("SnMessage")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnMessageEntity, (int)MonoSoftware.MonoX.DAL.EntityType.SnMessageEntity, 0, null, null, null, null, "SnMessage", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity SnMessage<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnMessage"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)SnMessageFieldIndex.Id, true); }
			set	{ SetValue((int)SnMessageFieldIndex.Id, value); }
		}

		/// <summary> The UserId property of the Entity SnMessage<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnMessage"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid UserId
		{
			get { return (System.Guid)GetValue((int)SnMessageFieldIndex.UserId, true); }
			set	{ SetValue((int)SnMessageFieldIndex.UserId, value); }
		}

		/// <summary> The DateCreated property of the Entity SnMessage<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnMessage"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)SnMessageFieldIndex.DateCreated, true); }
			set	{ SetValue((int)SnMessageFieldIndex.DateCreated, value); }
		}

		/// <summary> The Subject property of the Entity SnMessage<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnMessage"."Subject"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 255<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Subject
		{
			get { return (System.String)GetValue((int)SnMessageFieldIndex.Subject, true); }
			set	{ SetValue((int)SnMessageFieldIndex.Subject, value); }
		}

		/// <summary> The Body property of the Entity SnMessage<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnMessage"."Body"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Body
		{
			get { return (System.String)GetValue((int)SnMessageFieldIndex.Body, true); }
			set	{ SetValue((int)SnMessageFieldIndex.Body, value); }
		}

		/// <summary> The InReplyToMessageId property of the Entity SnMessage<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnMessage"."InReplyToMessageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid InReplyToMessageId
		{
			get { return (System.Guid)GetValue((int)SnMessageFieldIndex.InReplyToMessageId, true); }
			set	{ SetValue((int)SnMessageFieldIndex.InReplyToMessageId, value); }
		}

		/// <summary> The ToList property of the Entity SnMessage<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnMessage"."ToList"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String ToList
		{
			get { return (System.String)GetValue((int)SnMessageFieldIndex.ToList, true); }
			set	{ SetValue((int)SnMessageFieldIndex.ToList, value); }
		}
		...
		public virtual EntityCollection<SnMessageEntity> SnReplyMessages
		{
			get { return GetOrCreateEntityCollection<SnMessageEntity, SnMessageEntityFactory>("SnMessage", true, false, ref _snReplyMessages);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<SnMessageRecipientEntity, SnMessageRecipientEntityFactory>("SnMessage", true, false, ref _snMessageRecipients);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<SnRelationshipEntity, SnRelationshipEntityFactory>("SnMessage", true, false, ref _snRelationships);	}
		}
		...
		public virtual AspnetUsersEntity AspnetUser
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "SnMessages", "AspnetUser", _aspnetUser, true); 
				}
			}
		}
		...
		public virtual SnMessageEntity SnMessage
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "SnReplyMessages", "SnMessage", _snMessage, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.SnMessageEntity; }
		}
