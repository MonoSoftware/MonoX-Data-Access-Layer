...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
			...
			
	{
		...
		/// <summary> CTor</summary>
		/// <param name="id">PK value for AuditInfo which data should be fetched into this AuditInfo object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AuditInfoEntity(System.Guid id):base("AuditInfoEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this AuditInfoEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AuditInfoEntity(System.Guid id, IValidator validator):base("AuditInfoEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUser")[0], (int)MonoSoftware.MonoX.DAL.EntityType.AuditInfoEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>		
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)AuditInfoFieldIndex.Id, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.Id, value); }
		}
		...
		{
			get { return (System.Guid)GetValue((int)AuditInfoFieldIndex.UserId, true); }
		...
		/// <summary> The ActionType property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."ActionType"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>		
		public virtual System.Int32 ActionType
		{
			get { return (System.Int32)GetValue((int)AuditInfoFieldIndex.ActionType, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.ActionType, value); }
		}

		/// <summary> The ActionTypeName property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."ActionTypeName"<br/>
		...
		{
			get { return (System.String)GetValue((int)AuditInfoFieldIndex.ActionTypeName, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.ActionTypeName, value); }
		}

		/// <summary> The ActionPerformedByUser property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."ActionPerformedByUser"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 250<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>		
		public virtual System.String ActionPerformedByUser
		{
			get { return (System.String)GetValue((int)AuditInfoFieldIndex.ActionPerformedByUser, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.ActionPerformedByUser, value); }
		}
		...
		/// <summary> The ActionDataBinary property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."ActionDataBinary"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarBinary, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>		
		public virtual System.Byte[] ActionDataBinary
		{
			get { return (System.Byte[])GetValue((int)AuditInfoFieldIndex.ActionDataBinary, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.ActionDataBinary, value); }
		}

		/// <summary> The DateCreated property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>		
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)AuditInfoFieldIndex.DateCreated, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.DateCreated, value); }
		}

		/// <summary> The DateUpdated property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."DateUpdated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>		
		public virtual System.DateTime DateUpdated
		{
			get { return (System.DateTime)GetValue((int)AuditInfoFieldIndex.DateUpdated, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.DateUpdated, value); }
		}

		/// <summary> The ConcurrencyTimeStamp property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."ConcurrencyTimeStamp"<br/>
		/// Table field type characteristics (type, precision, scale, length): Timestamp, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>		
		public virtual System.Byte[] ConcurrencyTimeStamp
		{
			get { return (System.Byte[])GetValue((int)AuditInfoFieldIndex.ConcurrencyTimeStamp, true); }

		}

		/// <summary> The IpAddress property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."IpAddress"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>		
		public virtual System.String IpAddress
		{
			get { return (System.String)GetValue((int)AuditInfoFieldIndex.IpAddress, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.IpAddress, value); }
		}

		/// <summary> The UserAgent property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."UserAgent"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 255<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>		
		public virtual System.String UserAgent
		{
			get { return (System.String)GetValue((int)AuditInfoFieldIndex.UserAgent, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.UserAgent, value); }
		}

		/// <summary> The Referrer property of the Entity AuditInfo<br/><br/></summary>
		/// <remarks>Mapped on  table field: "AuditInfo"."Referrer"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>		
		public virtual System.String Referrer
		{
			get { return (System.String)GetValue((int)AuditInfoFieldIndex.Referrer, true); }
			set	{ SetValue((int)AuditInfoFieldIndex.Referrer, value); }
		}
		...
		public virtual AspnetUsersEntity AspnetUser
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AuditInfos", "AspnetUser", _aspnetUser, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.AuditInfoEntity; }
		}
