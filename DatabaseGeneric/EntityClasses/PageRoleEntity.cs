...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'PageRole'.<br/><br/></summary>
	[Serializable]
	public partial class PageRoleEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static PageRoleEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public PageRoleEntity():base("PageRoleEntity")
		{
		...
		public PageRoleEntity(IEntityFields2 fields):base("PageRoleEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this PageRoleEntity</param>
		public PageRoleEntity(IValidator validator):base("PageRoleEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for PageRole which data should be fetched into this PageRole object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PageRoleEntity(System.Guid id):base("PageRoleEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this PageRoleEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PageRoleEntity(System.Guid id, IValidator validator):base("PageRoleEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		protected PageRoleEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((PageRoleFieldIndex)fieldIndex)
			{
				case PageRoleFieldIndex.PageId:
					DesetupSyncPage(true, false);
					break;
				case PageRoleFieldIndex.RoleId:
		...
		{
			return new PageRoleRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(PageRoleEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetRoles, new PropertyChangedEventHandler( OnAspnetRolesPropertyChanged ), "AspnetRoles", MonoSoftware.MonoX.DAL.RelationClasses.StaticPageRoleRelations.AspnetRolesEntityUsingRoleIdStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)PageRoleFieldIndex.RoleId } );
			_aspnetRoles = null;
		}
		...
		private void SetupSyncAspnetRoles(IEntity2 relatedEntity)
		{
			if(_aspnetRoles!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetRoles, new PropertyChangedEventHandler( OnAspnetRolesPropertyChanged ), "AspnetRoles", MonoSoftware.MonoX.DAL.RelationClasses.StaticPageRoleRelations.AspnetRolesEntityUsingRoleIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _page, new PropertyChangedEventHandler( OnPagePropertyChanged ), "Page", MonoSoftware.MonoX.DAL.RelationClasses.StaticPageRoleRelations.PageEntityUsingPageIdStatic, true, signalRelatedEntity, "PageRoles", resetFKFields, new int[] { (int)PageRoleFieldIndex.PageId } );
			_page = null;
		}
		...
		private void SetupSyncPage(IEntity2 relatedEntity)
		{
			if(_page!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _page, new PropertyChangedEventHandler( OnPagePropertyChanged ), "Page", MonoSoftware.MonoX.DAL.RelationClasses.StaticPageRoleRelations.PageEntityUsingPageIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this PageRoleEntity</param>
		...
		public  static PageRoleRelations Relations
		{
			get	{ return new PageRoleRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetRolesEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetRoles")[0], (int)MonoSoftware.MonoX.DAL.EntityType.PageRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetRolesEntity, 0, null, null, null, null, "AspnetRoles", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PageEntityFactory))),	(IEntityRelation)GetRelationsForField("Page")[0], (int)MonoSoftware.MonoX.DAL.EntityType.PageRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.PageEntity, 0, null, null, null, null, "Page", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity PageRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PageRole"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)PageRoleFieldIndex.Id, true); }
			set	{ SetValue((int)PageRoleFieldIndex.Id, value); }
		}

		/// <summary> The PageId property of the Entity PageRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PageRole"."PageId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid PageId
		{
			get { return (System.Guid)GetValue((int)PageRoleFieldIndex.PageId, true); }
			set	{ SetValue((int)PageRoleFieldIndex.PageId, value); }
		}

		/// <summary> The RoleId property of the Entity PageRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "PageRole"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid RoleId
		{
			get { return (System.Guid)GetValue((int)PageRoleFieldIndex.RoleId, true); }
			set	{ SetValue((int)PageRoleFieldIndex.RoleId, value); }
		}
		...
		public virtual PageEntity Page
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "PageRoles", "Page", _page, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.PageRoleEntity; }
		}
