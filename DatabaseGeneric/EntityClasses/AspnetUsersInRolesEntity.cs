...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'AspnetUsersInRoles'.<br/><br/></summary>
	[Serializable]
	public partial class AspnetUsersInRolesEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static AspnetUsersInRolesEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public AspnetUsersInRolesEntity():base("AspnetUsersInRolesEntity")
		{
		...
		public AspnetUsersInRolesEntity(IEntityFields2 fields):base("AspnetUsersInRolesEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this AspnetUsersInRolesEntity</param>
		public AspnetUsersInRolesEntity(IValidator validator):base("AspnetUsersInRolesEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="userId">PK value for AspnetUsersInRoles which data should be fetched into this AspnetUsersInRoles object</param>
		/// <param name="roleId">PK value for AspnetUsersInRoles which data should be fetched into this AspnetUsersInRoles object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AspnetUsersInRolesEntity(System.Guid userId, System.Guid roleId):base("AspnetUsersInRolesEntity")
		{
			InitClassEmpty(null, null);
			this.UserId = userId;
			this.RoleId = roleId;
		...
		/// <param name="validator">The custom validator object for this AspnetUsersInRolesEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public AspnetUsersInRolesEntity(System.Guid userId, System.Guid roleId, IValidator validator):base("AspnetUsersInRolesEntity")
		{
			InitClassEmpty(validator, null);
			this.UserId = userId;
			this.RoleId = roleId;
		...
		protected AspnetUsersInRolesEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((AspnetUsersInRolesFieldIndex)fieldIndex)
			{
				case AspnetUsersInRolesFieldIndex.UserId:
					DesetupSyncAspnetUsers(true, false);
					break;
				case AspnetUsersInRolesFieldIndex.RoleId:
		...
		{
			return new AspnetUsersInRolesRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersInRolesEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetRoles, new PropertyChangedEventHandler( OnAspnetRolesPropertyChanged ), "AspnetRoles", MonoSoftware.MonoX.DAL.RelationClasses.StaticAspnetUsersInRolesRelations.AspnetRolesEntityUsingRoleIdStatic, true, signalRelatedEntity, "AspnetUsersInRoles", resetFKFields, new int[] { (int)AspnetUsersInRolesFieldIndex.RoleId } );
			_aspnetRoles = null;
		}

		/// <summary> setups the sync logic for member _aspnetRoles</summary>
		/// <param name="relatedEntity">Instance to set as the related entity of type entityType</param>
		private void SetupSyncAspnetRoles(IEntity2 relatedEntity)
		{
			if(_aspnetRoles!=relatedEntity)
			{
				DesetupSyncAspnetRoles(true, true);
				_aspnetRoles = (AspnetRolesEntity)relatedEntity;
				this.PerformSetupSyncRelatedEntity( _aspnetRoles, new PropertyChangedEventHandler( OnAspnetRolesPropertyChanged ), "AspnetRoles", MonoSoftware.MonoX.DAL.RelationClasses.StaticAspnetUsersInRolesRelations.AspnetRolesEntityUsingRoleIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncAspnetUsers(IEntity2 relatedEntity)
		{
			if(_aspnetUsers!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetUsers, new PropertyChangedEventHandler( OnAspnetUsersPropertyChanged ), "AspnetUsers", MonoSoftware.MonoX.DAL.RelationClasses.StaticAspnetUsersInRolesRelations.AspnetUsersEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this AspnetUsersInRolesEntity</param>
		...
		public  static AspnetUsersInRolesRelations Relations
		{
			get	{ return new AspnetUsersInRolesRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetRolesEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetRoles")[0], (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersInRolesEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetRolesEntity, 0, null, null, null, null, "AspnetRoles", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUsers")[0], (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersInRolesEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUsers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The UserId property of the Entity AspnetUsersInRoles<br/><br/></summary>
		/// <remarks>Mapped on  table field: "aspnet_UsersInRoles"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid UserId
		{
			get { return (System.Guid)GetValue((int)AspnetUsersInRolesFieldIndex.UserId, true); }
			set	{ SetValue((int)AspnetUsersInRolesFieldIndex.UserId, value); }
		}

		/// <summary> The RoleId property of the Entity AspnetUsersInRoles<br/><br/></summary>
		/// <remarks>Mapped on  table field: "aspnet_UsersInRoles"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid RoleId
		{
			get { return (System.Guid)GetValue((int)AspnetUsersInRolesFieldIndex.RoleId, true); }
			set	{ SetValue((int)AspnetUsersInRolesFieldIndex.RoleId, value); }
		}
		...
		public virtual AspnetRolesEntity AspnetRoles
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AspnetUsersInRoles", "AspnetRoles", _aspnetRoles, true); 
				}
			}
		}
		...
		public virtual AspnetUsersEntity AspnetUsers
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "AspnetUsersInRoles", "AspnetUsers", _aspnetUsers, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersInRolesEntity; }
		}
