...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'BlogEditor'.<br/><br/></summary>
	[Serializable]
	public partial class BlogEditorEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static BlogEditorEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public BlogEditorEntity():base("BlogEditorEntity")
		{
		...
		public BlogEditorEntity(IEntityFields2 fields):base("BlogEditorEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this BlogEditorEntity</param>
		public BlogEditorEntity(IValidator validator):base("BlogEditorEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for BlogEditor which data should be fetched into this BlogEditor object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BlogEditorEntity(System.Guid id):base("BlogEditorEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this BlogEditorEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public BlogEditorEntity(System.Guid id, IValidator validator):base("BlogEditorEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		protected BlogEditorEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((BlogEditorFieldIndex)fieldIndex)
			{
				case BlogEditorFieldIndex.BlogId:
					DesetupSyncBlog(true, false);
					break;
				case BlogEditorFieldIndex.UserId:
		...
		{
			return new BlogEditorRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(BlogEditorEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetUser, new PropertyChangedEventHandler( OnAspnetUserPropertyChanged ), "AspnetUser", MonoSoftware.MonoX.DAL.RelationClasses.StaticBlogEditorRelations.AspnetUsersEntityUsingUserIdStatic, true, signalRelatedEntity, "BlogEditors", resetFKFields, new int[] { (int)BlogEditorFieldIndex.UserId } );
			_aspnetUser = null;
		}
		...
		private void SetupSyncAspnetUser(IEntityCore relatedEntity)
		{
			if(_aspnetUser!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetUser, new PropertyChangedEventHandler( OnAspnetUserPropertyChanged ), "AspnetUser", MonoSoftware.MonoX.DAL.RelationClasses.StaticBlogEditorRelations.AspnetUsersEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _blog, new PropertyChangedEventHandler( OnBlogPropertyChanged ), "Blog", MonoSoftware.MonoX.DAL.RelationClasses.StaticBlogEditorRelations.BlogEntityUsingBlogIdStatic, true, signalRelatedEntity, "BlogEditors", resetFKFields, new int[] { (int)BlogEditorFieldIndex.BlogId } );
			_blog = null;
		}
		...
		private void SetupSyncBlog(IEntityCore relatedEntity)
		{
			if(_blog!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _blog, new PropertyChangedEventHandler( OnBlogPropertyChanged ), "Blog", MonoSoftware.MonoX.DAL.RelationClasses.StaticBlogEditorRelations.BlogEntityUsingBlogIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this BlogEditorEntity</param>
		...
		public  static BlogEditorRelations Relations
		{
			get	{ return new BlogEditorRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUser")[0], (int)MonoSoftware.MonoX.DAL.EntityType.BlogEditorEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(BlogEntityFactory))),	(IEntityRelation)GetRelationsForField("Blog")[0], (int)MonoSoftware.MonoX.DAL.EntityType.BlogEditorEntity, (int)MonoSoftware.MonoX.DAL.EntityType.BlogEntity, 0, null, null, null, null, "Blog", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity BlogEditor<br/><br/></summary>
		/// <remarks>Mapped on  table field: "BlogEditor"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>		
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)BlogEditorFieldIndex.Id, true); }
			set	{ SetValue((int)BlogEditorFieldIndex.Id, value); }
		}

		/// <summary> The BlogId property of the Entity BlogEditor<br/><br/></summary>
		/// <remarks>Mapped on  table field: "BlogEditor"."BlogId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>		
		public virtual System.Guid BlogId
		{
			get { return (System.Guid)GetValue((int)BlogEditorFieldIndex.BlogId, true); }
			set	{ SetValue((int)BlogEditorFieldIndex.BlogId, value); }
		}

		/// <summary> The UserId property of the Entity BlogEditor<br/><br/></summary>
		/// <remarks>Mapped on  table field: "BlogEditor"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>		
		public virtual System.Guid UserId
		{
			get { return (System.Guid)GetValue((int)BlogEditorFieldIndex.UserId, true); }
			set	{ SetValue((int)BlogEditorFieldIndex.UserId, value); }
		}
		...
		public virtual AspnetUsersEntity AspnetUser
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "BlogEditors", "AspnetUser", _aspnetUser, true); 
				}
			}
		}
		...
		public virtual BlogEntity Blog
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "BlogEditors", "Blog", _blog, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.BlogEditorEntity; }
		}
