...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'SnGroupRequest'.<br/><br/></summary>
	[Serializable]
	public partial class SnGroupRequestEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static SnGroupRequestEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public SnGroupRequestEntity():base("SnGroupRequestEntity")
		{
		...
		public SnGroupRequestEntity(IEntityFields2 fields):base("SnGroupRequestEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this SnGroupRequestEntity</param>
		public SnGroupRequestEntity(IValidator validator):base("SnGroupRequestEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for SnGroupRequest which data should be fetched into this SnGroupRequest object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnGroupRequestEntity(System.Guid id):base("SnGroupRequestEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this SnGroupRequestEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnGroupRequestEntity(System.Guid id, IValidator validator):base("SnGroupRequestEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		{
			switch((SnGroupRequestFieldIndex)fieldIndex)
			{
				case SnGroupRequestFieldIndex.UserId:
					DesetupSyncAspnetUser(true, false);
					break;
				case SnGroupRequestFieldIndex.GroupId:
		...
		{
			return new SnGroupRequestRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SnGroupRequestEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this SnGroupRequestEntity</param>
		...
		public  static SnGroupRequestRelations Relations
		{
			get	{ return new SnGroupRequestRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUser")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnGroupRequestEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(SnGroupEntityFactory))),	(IEntityRelation)GetRelationsForField("SnGroup")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnGroupRequestEntity, (int)MonoSoftware.MonoX.DAL.EntityType.SnGroupEntity, 0, null, null, null, null, "SnGroup", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity SnGroupRequest<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnGroupRequest"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)SnGroupRequestFieldIndex.Id, true); }
			set	{ SetValue((int)SnGroupRequestFieldIndex.Id, value); }
		}

		/// <summary> The UserId property of the Entity SnGroupRequest<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnGroupRequest"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid UserId
		{
			get { return (System.Guid)GetValue((int)SnGroupRequestFieldIndex.UserId, true); }
			set	{ SetValue((int)SnGroupRequestFieldIndex.UserId, value); }
		}

		/// <summary> The GroupId property of the Entity SnGroupRequest<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnGroupRequest"."GroupId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid GroupId
		{
			get { return (System.Guid)GetValue((int)SnGroupRequestFieldIndex.GroupId, true); }
			set	{ SetValue((int)SnGroupRequestFieldIndex.GroupId, value); }
		}

		/// <summary> The DateCreated property of the Entity SnGroupRequest<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnGroupRequest"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)SnGroupRequestFieldIndex.DateCreated, true); }
			set	{ SetValue((int)SnGroupRequestFieldIndex.DateCreated, value); }
		}

		/// <summary> The DateAccepted property of the Entity SnGroupRequest<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnGroupRequest"."DateAccepted"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> DateAccepted
		{
			get { return (Nullable<System.DateTime>)GetValue((int)SnGroupRequestFieldIndex.DateAccepted, false); }
			set	{ SetValue((int)SnGroupRequestFieldIndex.DateAccepted, value); }
		}

		/// <summary> The RequestType property of the Entity SnGroupRequest<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnGroupRequest"."RequestType"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 RequestType
		{
			get { return (System.Int32)GetValue((int)SnGroupRequestFieldIndex.RequestType, true); }
			set	{ SetValue((int)SnGroupRequestFieldIndex.RequestType, value); }
		}
		...
		public virtual AspnetUsersEntity AspnetUser
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "SnGroupRequests", "AspnetUser", _aspnetUser, true); 
				}
			}
		}
		...
		public virtual SnGroupEntity SnGroup
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "SnGroupRequests", "SnGroup", _snGroup, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.SnGroupRequestEntity; }
		}
