...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'NewsletterLog'.<br/><br/></summary>
	[Serializable]
	public partial class NewsletterLogEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static NewsletterLogEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public NewsletterLogEntity():base("NewsletterLogEntity")
		{
		...
		public NewsletterLogEntity(IEntityFields2 fields):base("NewsletterLogEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this NewsletterLogEntity</param>
		public NewsletterLogEntity(IValidator validator):base("NewsletterLogEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for NewsletterLog which data should be fetched into this NewsletterLog object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NewsletterLogEntity(System.Guid id):base("NewsletterLogEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this NewsletterLogEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public NewsletterLogEntity(System.Guid id, IValidator validator):base("NewsletterLogEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		{
			switch((NewsletterLogFieldIndex)fieldIndex)
			{
				case NewsletterLogFieldIndex.NewsletterId:
		...
		{
			return new NewsletterLogRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(NewsletterLogEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this NewsletterLogEntity</param>
		...
		public  static NewsletterLogRelations Relations
		{
			get	{ return new NewsletterLogRelations(); }
		}
		...
		/// <summary> The Id property of the Entity NewsletterLog<br/><br/></summary>
		/// <remarks>Mapped on  table field: "NewsletterLog"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)NewsletterLogFieldIndex.Id, true); }
			set	{ SetValue((int)NewsletterLogFieldIndex.Id, value); }
		}

		/// <summary> The NewsletterId property of the Entity NewsletterLog<br/><br/></summary>
		/// <remarks>Mapped on  table field: "NewsletterLog"."NewsletterId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid NewsletterId
		{
			get { return (System.Guid)GetValue((int)NewsletterLogFieldIndex.NewsletterId, true); }
			set	{ SetValue((int)NewsletterLogFieldIndex.NewsletterId, value); }
		}

		/// <summary> The Email property of the Entity NewsletterLog<br/><br/></summary>
		/// <remarks>Mapped on  table field: "NewsletterLog"."Email"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 200<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Email
		{
			get { return (System.String)GetValue((int)NewsletterLogFieldIndex.Email, true); }
			set	{ SetValue((int)NewsletterLogFieldIndex.Email, value); }
		}

		/// <summary> The SentOn property of the Entity NewsletterLog<br/><br/></summary>
		/// <remarks>Mapped on  table field: "NewsletterLog"."SentOn"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime SentOn
		{
			get { return (System.DateTime)GetValue((int)NewsletterLogFieldIndex.SentOn, true); }
			set	{ SetValue((int)NewsletterLogFieldIndex.SentOn, value); }
		}

		/// <summary> The Success property of the Entity NewsletterLog<br/><br/></summary>
		/// <remarks>Mapped on  table field: "NewsletterLog"."Success"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean Success
		{
			get { return (System.Boolean)GetValue((int)NewsletterLogFieldIndex.Success, true); }
			set	{ SetValue((int)NewsletterLogFieldIndex.Success, value); }
		}

		/// <summary> The Message property of the Entity NewsletterLog<br/><br/></summary>
		/// <remarks>Mapped on  table field: "NewsletterLog"."Message"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Message
		{
			get { return (System.String)GetValue((int)NewsletterLogFieldIndex.Message, true); }
			set	{ SetValue((int)NewsletterLogFieldIndex.Message, value); }
		}
		...
		public virtual NewsletterEntity Newsletter
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "NewsletterLogs", "Newsletter", _newsletter, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.NewsletterLogEntity; }
		}
