...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'PrivacyLevelDefinition'.<br/><br/></summary>
	[Serializable]
	public partial class PrivacyLevelDefinitionEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static PrivacyLevelDefinitionEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public PrivacyLevelDefinitionEntity():base("PrivacyLevelDefinitionEntity")
		{
		...
		public PrivacyLevelDefinitionEntity(IEntityFields2 fields):base("PrivacyLevelDefinitionEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this PrivacyLevelDefinitionEntity</param>
		public PrivacyLevelDefinitionEntity(IValidator validator):base("PrivacyLevelDefinitionEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for PrivacyLevelDefinition which data should be fetched into this PrivacyLevelDefinition object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PrivacyLevelDefinitionEntity(System.Guid id):base("PrivacyLevelDefinitionEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this PrivacyLevelDefinitionEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public PrivacyLevelDefinitionEntity(System.Guid id, IValidator validator):base("PrivacyLevelDefinitionEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		{
			switch((PrivacyLevelDefinitionFieldIndex)fieldIndex)
			{
				case PrivacyLevelDefinitionFieldIndex.UserId:
					DesetupSyncAspnetUsers(true, false);
					break;
				case PrivacyLevelDefinitionFieldIndex.PrivacyLevelId:
		...
		{
			return new PrivacyLevelDefinitionRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(PrivacyLevelDefinitionEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("ObjectName", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		/// <param name="validator">The validator object for this PrivacyLevelDefinitionEntity</param>
		...
		public  static PrivacyLevelDefinitionRelations Relations
		{
			get	{ return new PrivacyLevelDefinitionRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUsers")[0], (int)MonoSoftware.MonoX.DAL.EntityType.PrivacyLevelDefinitionEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUsers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(PrivacyLevelEntityFactory))),	(IEntityRelation)GetRelationsForField("PrivacyLevel")[0], (int)MonoSoftware.MonoX.DAL.EntityType.PrivacyLevelDefinitionEntity, (int)MonoSoftware.MonoX.DAL.EntityType.PrivacyLevelEntity, 0, null, null, null, null, "PrivacyLevel", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual System.Guid Id
		{
			...
			set	{ SetValue((int)PrivacyLevelDefinitionFieldIndex.Id, value); }
		}
		...
		public virtual System.Guid UserId
		{
			...
			set	{ SetValue((int)PrivacyLevelDefinitionFieldIndex.UserId, value); }
		}
		...
		public virtual System.String ObjectName
		{
			...
			set	{ SetValue((int)PrivacyLevelDefinitionFieldIndex.ObjectName, value); }
		}
		...
		public virtual System.String FieldName
		{
			...
			set	{ SetValue((int)PrivacyLevelDefinitionFieldIndex.FieldName, value); }
		}
		...
		public virtual System.Guid PrivacyLevelId
		{
			...
			set	{ SetValue((int)PrivacyLevelDefinitionFieldIndex.PrivacyLevelId, value); }
		}
		...
		public virtual Nullable<System.DateTime> DateEntered
		{
			...
			set	{ SetValue((int)PrivacyLevelDefinitionFieldIndex.DateEntered, value); }
		}
		...
		public virtual Nullable<System.DateTime> DateModified
		{
			...
			set	{ SetValue((int)PrivacyLevelDefinitionFieldIndex.DateModified, value); }
		}
		...
		public virtual AspnetUsersEntity AspnetUsers
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "PrivacyLevelDefinition", "AspnetUsers", _aspnetUsers, true); 
				}
			}
		}
		...
		public virtual PrivacyLevelEntity PrivacyLevel
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "PrivacyLevelDefinitions", "PrivacyLevel", _privacyLevel, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.PrivacyLevelDefinitionEntity; }
		}
