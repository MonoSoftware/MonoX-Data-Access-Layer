...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'CalendarEditRole'.<br/><br/></summary>
	[Serializable]
	public partial class CalendarEditRoleEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static CalendarEditRoleEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public CalendarEditRoleEntity():base("CalendarEditRoleEntity")
		{
		...
		public CalendarEditRoleEntity(IEntityFields2 fields):base("CalendarEditRoleEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this CalendarEditRoleEntity</param>
		public CalendarEditRoleEntity(IValidator validator):base("CalendarEditRoleEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="calendarId">PK value for CalendarEditRole which data should be fetched into this CalendarEditRole object</param>
		/// <param name="roleId">PK value for CalendarEditRole which data should be fetched into this CalendarEditRole object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CalendarEditRoleEntity(System.Guid calendarId, System.Guid roleId):base("CalendarEditRoleEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this CalendarEditRoleEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CalendarEditRoleEntity(System.Guid calendarId, System.Guid roleId, IValidator validator):base("CalendarEditRoleEntity")
		{
			InitClassEmpty(validator, null);
			this.CalendarId = calendarId;
			this.RoleId = roleId;
		...
		protected CalendarEditRoleEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((CalendarEditRoleFieldIndex)fieldIndex)
			{
				case CalendarEditRoleFieldIndex.CalendarId:
					DesetupSyncCalendar(true, false);
					break;
				case CalendarEditRoleFieldIndex.RoleId:
		...
		{
			return new CalendarEditRoleRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(CalendarEditRoleEntityFactory));
		}
#if !CF
		...
		private void SetupSyncAspnetRoles(IEntity2 relatedEntity)
		{
			if(_aspnetRoles!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetRoles, new PropertyChangedEventHandler( OnAspnetRolesPropertyChanged ), "AspnetRoles", MonoSoftware.MonoX.DAL.RelationClasses.StaticCalendarEditRoleRelations.AspnetRolesEntityUsingRoleIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this CalendarEditRoleEntity</param>
		...
		public  static CalendarEditRoleRelations Relations
		{
			get	{ return new CalendarEditRoleRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetRolesEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetRoles")[0], (int)MonoSoftware.MonoX.DAL.EntityType.CalendarEditRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetRolesEntity, 0, null, null, null, null, "AspnetRoles", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CalendarEntityFactory))),	(IEntityRelation)GetRelationsForField("Calendar")[0], (int)MonoSoftware.MonoX.DAL.EntityType.CalendarEditRoleEntity, (int)MonoSoftware.MonoX.DAL.EntityType.CalendarEntity, 0, null, null, null, null, "Calendar", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The CalendarId property of the Entity CalendarEditRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "CalendarEditRole"."CalendarId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid CalendarId
		{
			get { return (System.Guid)GetValue((int)CalendarEditRoleFieldIndex.CalendarId, true); }
			set	{ SetValue((int)CalendarEditRoleFieldIndex.CalendarId, value); }
		}

		/// <summary> The RoleId property of the Entity CalendarEditRole<br/><br/></summary>
		/// <remarks>Mapped on  table field: "CalendarEditRole"."RoleId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid RoleId
		{
			get { return (System.Guid)GetValue((int)CalendarEditRoleFieldIndex.RoleId, true); }
			set	{ SetValue((int)CalendarEditRoleFieldIndex.RoleId, value); }
		}
		...
		public virtual AspnetRolesEntity AspnetRoles
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "CalendarEditRoles", "AspnetRoles", _aspnetRoles, true); 
				}
			}
		}
		...
		public virtual CalendarEntity Calendar
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "CalendarEditRoles", "Calendar", _calendar, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.CalendarEditRoleEntity; }
		}
