...
namespace MonoSoftware.MonoX.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'SnFriend'.<br/><br/></summary>
	[Serializable]
	public partial class SnFriendEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static SnFriendEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public SnFriendEntity():base("SnFriendEntity")
		{
		...
		public SnFriendEntity(IEntityFields2 fields):base("SnFriendEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this SnFriendEntity</param>
		public SnFriendEntity(IValidator validator):base("SnFriendEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for SnFriend which data should be fetched into this SnFriend object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnFriendEntity(System.Guid id):base("SnFriendEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this SnFriendEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public SnFriendEntity(System.Guid id, IValidator validator):base("SnFriendEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		protected SnFriendEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((SnFriendFieldIndex)fieldIndex)
			{
				case SnFriendFieldIndex.UserId:
					DesetupSyncAspnetUser(true, false);
					break;
				case SnFriendFieldIndex.FriendUserId:
		...
		{
			return new SnFriendRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(SnFriendEntityFactory));
		}
#if !CF
		...
		{
			this.PerformDesetupSyncRelatedEntity( _aspnetUser, new PropertyChangedEventHandler( OnAspnetUserPropertyChanged ), "AspnetUser", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnFriendRelations.AspnetUsersEntityUsingUserIdStatic, true, signalRelatedEntity, "SnFriendsUsers", resetFKFields, new int[] { (int)SnFriendFieldIndex.UserId } );
			_aspnetUser = null;
		}
		...
		private void SetupSyncAspnetUser(IEntity2 relatedEntity)
		{
			if(_aspnetUser!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _aspnetUser, new PropertyChangedEventHandler( OnAspnetUserPropertyChanged ), "AspnetUser", MonoSoftware.MonoX.DAL.RelationClasses.StaticSnFriendRelations.AspnetUsersEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this SnFriendEntity</param>
		...
		public  static SnFriendRelations Relations
		{
			get	{ return new SnFriendRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUser")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnFriendEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUser", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AspnetUsersEntityFactory))),	(IEntityRelation)GetRelationsForField("AspnetUserFriend")[0], (int)MonoSoftware.MonoX.DAL.EntityType.SnFriendEntity, (int)MonoSoftware.MonoX.DAL.EntityType.AspnetUsersEntity, 0, null, null, null, null, "AspnetUserFriend", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity SnFriend<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnFriend"."Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.Guid Id
		{
			get { return (System.Guid)GetValue((int)SnFriendFieldIndex.Id, true); }
			set	{ SetValue((int)SnFriendFieldIndex.Id, value); }
		}

		/// <summary> The UserId property of the Entity SnFriend<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnFriend"."UserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid UserId
		{
			get { return (System.Guid)GetValue((int)SnFriendFieldIndex.UserId, true); }
			set	{ SetValue((int)SnFriendFieldIndex.UserId, value); }
		}

		/// <summary> The FriendUserId property of the Entity SnFriend<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnFriend"."FriendUserId"<br/>
		/// Table field type characteristics (type, precision, scale, length): UniqueIdentifier, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Guid FriendUserId
		{
			get { return (System.Guid)GetValue((int)SnFriendFieldIndex.FriendUserId, true); }
			set	{ SetValue((int)SnFriendFieldIndex.FriendUserId, value); }
		}

		/// <summary> The DateCreated property of the Entity SnFriend<br/><br/></summary>
		/// <remarks>Mapped on  table field: "SnFriend"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)SnFriendFieldIndex.DateCreated, true); }
			set	{ SetValue((int)SnFriendFieldIndex.DateCreated, value); }
		}
		...
		public virtual AspnetUsersEntity AspnetUser
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "SnFriendsUsers", "AspnetUser", _aspnetUser, true); 
				}
			}
		}
		...
		public virtual AspnetUsersEntity AspnetUserFriend
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "SnFriendsFriends", "AspnetUserFriend", _aspnetUserFriend, true); 
				}
			}
		}
		...
		{ 
			get { return (int)MonoSoftware.MonoX.DAL.EntityType.SnFriendEntity; }
		}
